...
const machine_t machines[] = {
    ...
    { "[8088] Thomson TO16PC",			"to16_pc",		{{"Intel",      cpus_8088},   {"",      NULL},       {"",      NULL},        {"",      NULL},     {"",      NULL}}, MACHINE_ISA | MACHINE_VIDEO | MACHINE_VIDEO_FIXED,      512,  768, 128,   0,	     machine_thomson_to16pc, to16pc_get_device	},
