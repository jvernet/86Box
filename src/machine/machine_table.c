...
const machine_t machines[] = {
    ...
    { "[386DX ISA] Compaq Deskpro (386)",  "deskpro386",       {{"Intel", cpus_i386DX},      {"AMD", cpus_Am386DX}, {"Cyrix", cpus_486DLC}, {"",      NULL},     {"",      NULL}}, MACHINE_ISA | MACHINE_AT | MACHINE_HDC,           			  			  1,   14,   1, 127,   machine_at_deskpro386_init, NULL	},
